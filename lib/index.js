...
(function() {
  var Extractor, InfoJSONCreator, Informer, Parser, _, app, cache, express, fs, iiif, image_extraction, path, resolve_image_path, tempfile;
    ...
    extractor_cb = function(image) {
      ...
      if (!cache.get(url)) {
        ...
        return fs.writeFile(image_path, image, function(err) {
          return cache.put(url, image_path);
        });
      }
    };

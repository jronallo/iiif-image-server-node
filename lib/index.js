...
(function() {
  var NodeCache, app, checkperiod, config, express, fs, image_cache, image_response, info_cache, info_json_response, path, port, resolve_image_path, ttl;
  ...
  app.get('*.:format(jpg|png)', function(req, res) {
    if (req.url.match('pct:')) {
      return res.status(400).send('400 pct: not implemented');
    } else {

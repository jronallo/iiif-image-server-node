...
(function() {
  var NodeCache, app, bunyan, config, express, fs, image_response, info_cache, info_cache_checkperiod, info_cache_ttl, info_json_response, log, log_file_path, path, port, resolve_image_path, viewer_path;

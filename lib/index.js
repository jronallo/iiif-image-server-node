...
(function() {
  var Extractor, InfoJSONCreator, Informer, Parser, _, app, cache, express, fs, iiif, path, resolve_image_path;
  ...
  app.get('*.(jpg|png)', function(req, res) {
    ...
    extractor_cb = function(output_image_path) {
      return res.sendFile(output_image_path, function() {
        return fs.unlink(output_image_path);
      });
    };
    info_cb = function(info) {

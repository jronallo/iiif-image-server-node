...
(function() {
  var InfoJSONCreator, Informer, NodeCache, Parser, Validator, _, app, express, fs, iiif, image_cache, image_extraction, info_cache, path, resolve_image_path;
  ...
  app.get('*.(jpg|png)', function(req, res) {
    var image_path, params, parser, url;
    url = req.url;
     ...
     */
    return fs.stat(image_path, function(err, stats) {
      var cache_image_path, validator;
      if (err) {

...
(function() {
  var _, async, bunyan, clear_cache_for_id, clear_cache_from_profile, config, fs, log, log_file_path, path, profile_string, profiles, regex, resolve_base_cache_path, rimraf, time_difference_profile_image, time_difference_random_image;

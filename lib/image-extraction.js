...
(function() {
  var Extractor, Informer, Validator, _, config, fs, iiif, image_extraction, info_cache, jp2_binary, log, mkdirp, path, path_for_cache_file, resolve_image_path, tempfile, too_big;
